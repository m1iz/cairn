...
import { CurrentRuntimeEventRepositoryFactory } from './current-runtime-event-repository'
...
describe('current runtime event repository adapter', () => {
  it('reads legacy projection rows and appends without migrating the file', () => {
    ...
    const factory = new CurrentRuntimeEventRepositoryFactory()
