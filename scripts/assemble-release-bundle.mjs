...
const artifactRules = [
  ['macos-arm64-dmg', new RegExp(`^Cairn-Agent-${version}-mac-arm64\\.dmg$`)],
  ['macos-arm64-zip', new RegExp(`^Cairn-Agent-${version}-mac-arm64\\.zip$`)],
  ['macos-x64-dmg', new RegExp(`^Cairn-Agent-${version}-mac-x64\\.dmg$`)],
  ['macos-x64-zip', new RegExp(`^Cairn-Agent-${version}-mac-x64\\.zip$`)],
  ['windows-x64', new RegExp(`^Cairn-Agent-${version}-win-x64\\.exe$`)],
  [
    'linux-appimage',
    new RegExp(`^Cairn-Agent-${version}-linux-x64\\.AppImage$`),
  ],
  ['linux-deb', new RegExp(`^Cairn-Agent-${version}-linux-x64\\.deb$`)],
]
